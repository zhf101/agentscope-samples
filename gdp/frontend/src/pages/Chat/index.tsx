...
import { ChatModeType, LANGUAGETYPE, normalizeChatMode } from "@/utils/constant";
...
export const Chat = () => {
  ...
  const createNewConversation = async (
    ...
    try {
      ...
      const newConversation: Conversation = {
        ...
        chat_mode: normalizeChatMode(response?.payload?.chat_mode),
      };
      setCurrentConversation(newConversation);
      setChatMode(normalizeChatMode(response?.payload?.chat_mode));
  ...
  const handleSelectConversation = async (conversation: Conversation) => {
    try {
      ...
      setChatMode(normalizeChatMode(conversation.chat_mode));
